  ...
  <div class="animated fadeIn">
    <b-row>
      <b-col md="6">
        <b-card>
          <div slot="header">
            <strong>Adicionar</strong> categoria
          </div>
          ...
          <b-form-group
            ...
            :label-cols="3"
            >
            <b-form-textarea v-model="item.description" id="basicTextarea" :rows="3" placeholder="Conteúdo.."></b-form-textarea>
          </b-form-group>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      axios.post(`/market/category`, this.item)
      .then((response) =>{
